...
class ResetFunctionalCest//For coverage
{
    ...
    public function it_outputs_error_on_non_existing_email_for_password_reset_form( FunctionalTester $I )
    {
        $I->amOnRoute(PasswordResetPage::$ROUTE);
...
//PASSWORD CHANGE FORM
    ...
    public function it_validates_required_password_change_form_email_field( FunctionalTester $I )
    {
    ...
    public function it_throws_exception_when_no_token_supplied( FunctionalTester $I )
    {
        $I->amOnPage(PasswordChangePage::$PAGE_PLAIN);
        $I->see('MethodNotAllowedHttpException');
    }

    public function it_validates_required_password_change_form_password_field( FunctionalTester $I )
    {
        $I->amOnPage(PasswordChangePage::$PAGE);
    ...
    public function it_validates_matching_password_change_form_password_confirmation_field( FunctionalTester $I )
    {
        $I->amOnPage(PasswordChangePage::$PAGE);
    ...
    public function it_outputs_error_on_non_matching_email_reset_request_for_password_change_form( FunctionalTester $I )
    {
        $I->amOnPage(PasswordChangePage::$PAGE);
    ...
    public function it_validates_password_length_for_password_change_form( FunctionalTester $I )
    {
    ...
    public function it_validates_token_in_password_change_form( FunctionalTester $I )
    {
        $email = 'email@example.com';//Existing record in DB

        $I->amOnPage(PasswordChangePage::$PAGE_PLAIN . 'x');//Not existing token in the DB
        ...
        $I->see('Your token or URL for password reset is not valid.');
    }
